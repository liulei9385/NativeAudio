...
public final class FlacExtractor implements Extractor {
    ...
    private static final byte[] FLAC_SIGNATURE_OTHER = {0x49, 0x44, 0x33, 0x03, 0x00, 0x00, 0x00, 0x00};
    ...
    public boolean sniff(ExtractorInput input) throws IOException, InterruptedException {
        ...
        return Arrays.equals(header, FLAC_SIGNATURE) || Arrays.equals(header, FLAC_SIGNATURE_OTHER) ||
                Arrays.equals(Arrays.copyOf(header, 4), Arrays.copyOf(FLAC_SIGNATURE_OTHER, 4));
    }
