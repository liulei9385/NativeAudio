...
jint Java_hello_leilei_nativeaudio_NativeAudio_getPlayingUriAudioPlayer(
...
void Java_hello_leilei_nativeaudio_NativeAudio_setVolumeUriAudioPlayer(JNIEnv *env,
                                                                       jclass clazz,
                                                                       jint millibel) {
    SLresult result;
...
jboolean Java_hello_leilei_nativeaudio_NativeAudio_createAssetAudioPlayer(JNIEnv *env,
                                                                          jclass clazz,
...
jboolean Java_hello_leilei_nativeaudio_NativeAudio_createAudioRecorder(JNIEnv *env,
                                                                       jclass clazz) {
    SLresult result;
